...
root.configure(bg="#6a5acd")  # Solid background
...
from_combo = ttk.Combobox(frame, values=["Celsius", "Fahrenheit"], state="readonly")
...
to_combo = ttk.Combobox(frame, values=["Celsius", "Fahrenheit"], state="readonly")
...
# Temperature input box (no default text)
